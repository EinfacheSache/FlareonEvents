...
public class AssassinsHelmet implements Listener {
    ...
    public static NamespacedKey NAMESPACED_KEY = new NamespacedKey(FlareonEvents.getPlugin(), "assassins_helmet");
    public static Material MATERIAL = Material.LEATHER_HELMET;
    public static String DISPLAY_NAME = "§6§lAssassins Helmet";
