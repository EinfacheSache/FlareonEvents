...
public class SpearCrystal {

    public static final String DISPLAY_NAME = "§6Speer Krystal";
    public static final NamespacedKey NAMESPACED_KEY = new NamespacedKey(FlareonEvents.getPlugin(), "spear_crystal");
